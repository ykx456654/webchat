...
;(function(){
    var Transform = require('../alloyfinger/transformjs/transform.js')
    var AlloyFinger =  require('../alloyfinger/alloy_finger.js')
    ...
    var AlloyCrop = function (option) {
        ...
        this.croppingBox.className = "alloy-crop"
        ...
        this.ok = option.ok;
        this.ow = option.natureSizeW
        this.oh = option.natureSizeH
        ...
        // alert(typeof option.image_src)
        
        if (typeof option.image_src === 'object') {
            var url = URL.createObjectURL(option.image_src);
            option.image_src = url
        }
        // alert(option.image_src)
    ...
    AlloyCrop.prototype = {
        init: function () {
            // alert(1)
            this.img_width = this.img.width!==0?this.img.width:this.ow;
            this.img_height = this.img.height!==0?this.img.height:this.oh;
        ...
        _ok: function () {
            ...
            // this.ok(this.canvas.toDataURL(),this.canvas)
        },
        ...
        crop: function () {
            this.calculateRect();
            // var IMAG = this.img
            // var a = document.querySelector('.alloy-crop img')
            // alert(IMAG)
            var degree = 0
